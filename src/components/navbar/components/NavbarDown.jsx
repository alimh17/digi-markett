    ...
    <>
      ...
      <ul className="hidden md:flex w-full my-5 px-5 ">
        <div className="flex w-2/3">
          ...
          <li className="mx-1 lg:mx-3 py-3 text-sm lg:text-lg cursor-pointer hover:border-b-red-400 hover:border-b-2 transition-all duration-75 rounded-sm text-gray-400">
